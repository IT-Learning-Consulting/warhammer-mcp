...
// Module Integration v2 Phase 13C — Zod schema (promoted to @foundry-mcp/shared, ADR-020) for module-syrinscape (Syrinscape Control v1.0.5, Zhell).
//
// CCR-5: module-specific schemas are promoted to @foundry-mcp/shared (ADR-020, Phase C2). Every variant is a plain `.strict()` ZodObject (NO
