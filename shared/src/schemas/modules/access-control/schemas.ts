...
export const ACCESS_CONTROL_BUNDLE_MEMBERS = ['LocknKey', 'LockView'] as const;
export type AccessControlBundleMemberId = (typeof ACCESS_CONTROL_BUNDLE_MEMBERS)[number];
