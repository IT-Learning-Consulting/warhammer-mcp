...
// Module Integration v2 Phase 4 — Zod schema (promoted to @foundry-mcp/shared, ADR-020) for module-perceptive
...
import { z } from 'zod';
import { TokenId, SceneId, WallId } from '../../branded-ids.js';
