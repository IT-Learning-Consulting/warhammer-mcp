...
// Module Integration v2 Phase 13B — Zod schema (promoted to @foundry-mcp/shared, ADR-020) for module-puzzle-locks (Puzzle Locks v3.1.4, theripper93).
//
// CCR-5: module-specific schemas are promoted to @foundry-mcp/shared (ADR-020, Phase C2). `.strict()` on every top-level action variant per the
