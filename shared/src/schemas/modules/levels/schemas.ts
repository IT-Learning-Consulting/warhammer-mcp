...
// Module Integration v1 Phase 4 — Zod schema (promoted to @foundry-mcp/shared, ADR-020) for module-levels.
//
...
import { z } from 'zod';
import { SceneId, TokenId, TileId, WallId, MeasuredTemplateId, RegionId } from '../../branded-ids.js';
...
export const ModuleLevelsInput = z.discriminatedUnion('action', [
  ...
  z.object({
    ...
    sceneId: SceneId.optional(), // defaults to canvas.scene
    levels: z.array(
