...
// Module Integration v2 Phase 3B — Zod schema (promoted to @foundry-mcp/shared, ADR-020) for module-token-presentation
...
import { z } from 'zod';
import { SceneId, TokenId, ActorId } from '../../branded-ids.js';
