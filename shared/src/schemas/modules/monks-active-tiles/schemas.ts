...
// Module Integration v1 Phase 2 — input schema (promoted to @foundry-mcp/shared, ADR-020) for monks-active-tiles.
//
// CCR-5 convention: module-specific Zod schemas are promoted to @foundry-mcp/shared (ADR-020, Phase C2).
