...
// Module Integration v1 Phase 14 — Zod schema (promoted to @foundry-mcp/shared, ADR-020) for module-patrol (patrol v3.0.3).
//
...
import { z } from 'zod';
import { FoundryUuid, SceneId, DrawingId } from '../../branded-ids.js';
...
export const ModulePatrolInput = z.discriminatedUnion('action', [
  ...
  z
    .object({
      ...
      drawingId: DrawingId.optional(), // reference an existing Drawing instead of creating
    })
    .strict(),
  z
    .object({
