...
// Module Integration v2 Phase 13A — Zod schema (promoted to @foundry-mcp/shared, ADR-020) for module-portal (Portal v3.0.4, Posh Rat Games).
//
// CCR-5: module-specific schema are promoted to @foundry-mcp/shared (ADR-020, Phase C2). Single `.strict()` ZodObject (one action -> a plain
