# MagicalGloomDarknessShader | Foundry Virtual Tabletop - API Documentation - Version 13

Creates a gloomy ring of pure darkness.

**Hierarchy:**  
[View Summary](https://foundryvtt.com/api/hierarchy.html#foundry.canvas.rendering.shaders.MagicalGloomDarknessShader)  
...
For the full Foundry Virtual Tabletop API documentation, please visit the [Foundry Virtual Tabletop - API Documentation - Version 13](https://foundryvtt.com/api/index.html).