...
[Foundry Virtual Tabletop - API Documentation - Version 13](https://foundryvtt.com/api/modules.html) / [foundry](https://foundryvtt.com/api/modules/foundry.html) / [canvas](https://foundryvtt.com/api/modules/foundry.canvas.html) / [rendering](https://foundryvtt.com/api/modules/foundry.canvas.rendering.html) / [shaders](https://foundryvtt.com/api/modules/foundry.canvas.rendering.shaders.html) / [FlameColorationShader](https://foundryvtt.com/api/classes/foundry.canvas.rendering.shaders.FlameColorationShader.html)
...
- **initialUniforms**: `object`  
  Initial uniform values to use in creation.
...
- [AdaptiveColorationShader Documentation](https://foundryvtt.com/api/classes/foundry.canvas.rendering.shaders.AdaptiveColorationShader.html)
- [ShaderTechnique Interface](https://foundryvtt.com/api/interfaces/foundry.ShaderTechnique.html)
- [AbstractBaseShader Documentation](https://foundryvtt.com/api/classes/foundry.canvas.rendering.shaders.AbstractBaseShader.html)