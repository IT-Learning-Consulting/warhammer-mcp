# TextureData | Foundry Virtual Tabletop - API Documentation - Version 13

A [foundry.data.fields.SchemaField](https://foundryvtt.com/api/classes/foundry.data.fields.SchemaField.html) subclass used to represent texture data.

## Hierarchy  
[View Summary](https://foundryvtt.com/api/hierarchy.html#foundry.data.TextureData)  
- *SchemaField*  
- **TextureData**
...
new TextureData(
    ...
    srcOptions?: Pick<
        ...
        "label" | "wildcard" | "initial" | "categories"
    >,
): TextureData
```
...
- **srcOptions**: `Pick<FilePathFieldOptions, "label" | "wildcard" | "initial" | "categories">` = {}  
...
**Returns** `string`  
Inherited from [fields.SchemaField.fieldPath](https://foundryvtt.com/api/classes/foundry.data.fields.SchemaField.html#fieldPath)
...
Inherited from [fields.SchemaField._defaults](https://foundryvtt.com/api/classes/foundry.data.fields.SchemaField.html#_defaults)
...
**Returns** `boolean`  
Inherited from [fields.SchemaField.hasFormSupport](https://foundryvtt.com/api/classes/foundry.data.fields.SchemaField.html#hasFormSupport)
...
Inherited from [SchemaField._cast](https://foundryvtt.com/api/classes/foundry.data.fields.SchemaField.html#_cast)
...
### _getField
```typescript
_getField(path: any): undefined | DataField | TextureData
```
...
**Returns**  
`undefined | DataField | TextureData`  
...
```
The SchemaField#update method plays a special role of recursively dispatching  
DataField#update operations to the constituent fields within the schema.
...
Inherited from [SchemaField._validateModel](https://foundryvtt.com/api/classes/foundry.data.fields.SchemaField.html#_validateModel)
...
**Returns** `Generator<DataField, void, unknown>`  
...
```
Coerce source data to ensure that it conforms to the correct data type for the field. Data  
coercion operations should be simple and synchronous as these are applied whenever a  
DataModel is constructed. For one-off cleaning of user-provided input the sanitize method  
should be used.
...
Inherited from [SchemaField.clean](https://foundryvtt.com/api/classes/foundry.data.fields.SchemaField.html#clean)
...
Inherited from [SchemaField.initialize](https://foundryvtt.com/api/classes/foundry.data.fields.SchemaField.html#initialize)
...
Inherited from [SchemaField.migrateSource](https://foundryvtt.com/api/classes/foundry.data.fields.SchemaField.html#migrateSource)
...
Inherited from [SchemaField.toObject](https://foundryvtt.com/api/classes/foundry.data.fields.SchemaField.html#toObject)
...
```
Validate a candidate input for this field, ensuring it meets the field requirements. A validation  
failure can be provided as a raised Error (with a string message), by returning false, or by  
returning a DataModelValidationFailure instance. A validator which returns true denotes that  
the result is certainly valid and further validations are unnecessary.
...
Inherited from [SchemaField.validate](https://foundryvtt.com/api/classes/foundry.data.fields.SchemaField.html#validate)
...
```
Render this DataField as an HTML element. Subclasses should implement this method rather  
than the public toInput method which wraps it.
...
```
Special validation rules which supersede regular field validation. This validator screens for  
certain values which are otherwise incompatible with this field like null or undefined.
