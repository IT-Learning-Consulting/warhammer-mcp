# ServerSettings | Foundry Virtual Tabletop - API Documentation - Version 13

A data model definition which describes the application configuration options. These options are persisted in the user data Config folder in the `options.json` file. The server-side software extends this class and provides additional validations.

## Hierarchy  
[View Summary](https://foundryvtt.com/api/hierarchy.html#foundry.config.ServerSettings)
...
### Abstract: defineSchema

```typescript
static defineSchema(): {
    adminPassword: StringField;
    awsConfig: StringField;
    compressSocket: BooleanField;
    compressStatic: BooleanField;
    cssTheme: StringField;
    dataPath: StringField;
    deleteNEDB: BooleanField;
    fullscreen: BooleanField;
    hostname: StringField;
    hotReload: BooleanField;
    language: StringField;
    localHostname: StringField;
    noBackups: BooleanField;
    passwordSalt: StringField;
    port: NumberField;
    protocol: NumberField;
    proxyPort: NumberField;
    proxySSL: BooleanField;
    routePrefix: StringField;
    sslCert: StringField;
    sslKey: StringField;
    telemetry: BooleanField;
    updateChannel: StringField;
    upnp: BooleanField;
    upnpLeaseDuration: NumberField;
    world: StringField;
}
```
...
An object defining fields as instances of classes like [`StringField`](https://foundryvtt.com/api/classes/foundry.data.fields.StringField.html), [`BooleanField`](https://foundryvtt.com/api/classes/foundry.data.fields.BooleanField.html), and [`NumberField`](https://foundryvtt.com/api/classes/foundry.data.fields.NumberField.html).
...
Migrate provided data to the current schema version.
