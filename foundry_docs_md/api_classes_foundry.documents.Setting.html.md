# Setting | Foundry Virtual Tabletop - API Documentation - Version 13

The client-side **Setting** document which extends the common [`BaseSetting`](https://foundryvtt.com/api/classes/foundry.documents.BaseSetting.html) model.
...
- [`foundry.documents.collections.WorldSettings`](https://foundryvtt.com/api/classes/foundry.documents.collections.WorldSettings.html): The world-level collection of Setting documents

---

## Hierarchy ([View Summary](https://foundryvtt.com/api/hierarchy.html#foundry.documents.Setting))
...
Inherited from [`BaseSetting.constructor`](https://foundryvtt.com/api/classes/foundry.documents.BaseSetting.html#constructor)
...
Inherited from [`BaseSetting._source`](https://foundryvtt.com/api/classes/foundry.documents.BaseSetting.html#_source)
...
Inherited from [`BaseSetting.parent`](https://foundryvtt.com/api/classes/foundry.documents.BaseSetting.html#parent)
...
Inherited from [`BaseSetting.LOCALIZATION_PREFIXES`](https://foundryvtt.com/api/classes/foundry.documents.BaseSetting.html#localization_prefixes)
...
Inherited from [`BaseSetting.metadata`](https://foundryvtt.com/api/classes/foundry.documents.BaseSetting.html#metadata)

### config

```typescript
get config(): undefined | SettingsConfig
```

The setting configuration for this setting document.

**Returns**  
`undefined` | [`SettingsConfig`](https://foundryvtt.com/api/classes/foundry.applications.settings.SettingsConfig.html)
...
Inherited from [`BaseSetting._configure`](https://foundryvtt.com/api/classes/foundry.documents.BaseSetting.html#_configure)
...
Overrides [`BaseSetting._initialize`](https://foundryvtt.com/api/classes/foundry.documents.BaseSetting.html#_initialize)
...
Overrides [`BaseSetting._onCreate`](https://foundryvtt.com/api/classes/foundry.documents.BaseSetting.html#_oncreate)
...
Overrides [`BaseSetting._onUpdate`](https://foundryvtt.com/api/classes/foundry.documents.BaseSetting.html#_onupdate)
...
Inherited from [`BaseSetting.canUserModify`](https://foundryvtt.com/api/classes/foundry.documents.BaseSetting.html#canusermodify)
...
**Returns**  
The cloned Document instance either synchronously or wrapped in a Promise.

Inherited from [`BaseSetting.clone`](https://foundryvtt.com/api/classes/foundry.documents.BaseSetting.html#clone)
...
Inherited from [`BaseSetting.createEmbeddedDocuments`](https://foundryvtt.com/api/classes/foundry.documents.BaseSetting.html#createembeddeddocuments)
...
Inherited from [`BaseSetting.delete`](https://foundryvtt.com/api/classes/foundry.documents.BaseSetting.html#delete)
...
Inherited from [`BaseSetting.deleteEmbeddedDocuments`](https://foundryvtt.com/api/classes/foundry.documents.BaseSetting.html#deleteembeddeddocuments)
...
Inherited from [`BaseSetting.getEmbeddedCollection`](https://foundryvtt.com/api/classes/foundry.documents.BaseSetting.html#getembeddedcollection)
...
- `options` (optional): `{ invalid?: boolean; strict?: boolean }` = `{}`  
  ...
  - `strict` (optional): `boolean` - Throw an Error if the requested id does not exist.
...
Inherited from [`BaseSetting.getEmbeddedDocument`](https://foundryvtt.com/api/classes/foundry.documents.BaseSetting.html#getembeddeddocument)
...
Inherited from [`BaseSetting.getFlag`](https://foundryvtt.com/api/classes/foundry.documents.BaseSetting.html#getflag)
...
Inherited from [`BaseSetting.getUserLevel`](https://foundryvtt.com/api/classes/foundry.documents.BaseSetting.html#getuserlevel)
...
Inherited from [`BaseSetting.migrateSystemData`](https://foundryvtt.com/api/classes/foundry.documents.BaseSetting.html#migratesystemdata)
...
Inherited from [`BaseSetting.reset`](https://foundryvtt.com/api/classes/foundry.documents.BaseSetting.html#reset)
...
Inherited from [`BaseSetting.setFlag`](https://foundryvtt.com/api/classes/foundry.documents.BaseSetting.html#setflag)
...
Inherited from [`BaseSetting.testUserPermission`](https://foundryvtt.com/api/classes/foundry.documents.BaseSetting.html#testuserpermission)
...
Inherited from [`BaseSetting.toJSON`](https://foundryvtt.com/api/classes/foundry.documents.BaseSetting.html#tojson)
...
Inherited from [`BaseSetting.toObject`](https://foundryvtt.com/api/classes/foundry.documents.BaseSetting.html#toobject)
...
Inherited from [`BaseSetting.traverseEmbeddedDocuments`](https://foundryvtt.com/api/classes/foundry.documents.BaseSetting.html#traverseembeddeddocuments)
...
Inherited from [`BaseSetting.unsetFlag`](https://foundryvtt.com/api/classes/foundry.documents.BaseSetting.html#unsetflag)
...
Inherited from [`BaseSetting.update`](https://foundryvtt.com/api/classes/foundry.documents.BaseSetting.html#update)
...
Inherited from [`BaseSetting.updateEmbeddedDocuments`](https://foundryvtt.com/api/classes/foundry.documents.BaseSetting.html#updateembeddeddocuments)
...
Inherited from [`BaseSetting.updateSource`](https://foundryvtt.com/api/classes/foundry.documents.BaseSetting.html#updatesource)
...
Inherited from [`BaseSetting.validate`](https://foundryvtt.com/api/classes/foundry.documents.BaseSetting.html#validate)
...
**Returns**  
Migrated and cleaned source data which will be stored to the model instance (same object as `data` argument)

Inherited from [`BaseSetting._initializeSource`](https://foundryvtt.com/api/classes/foundry.documents.BaseSetting.html#_initializesource)
...
Inherited from [`BaseSetting._onDelete`](https://foundryvtt.com/api/classes/foundry.documents.BaseSetting.html#_ondelete)
...
Inherited from [`BaseSetting._preCreate`](https://foundryvtt.com/api/classes/foundry.documents.BaseSetting.html#_precreate)
...
Inherited from [`BaseSetting._preDelete`](https://foundryvtt.com/api/classes/foundry.documents.BaseSetting.html#_predelete)
...
Inherited from [`BaseSetting._preUpdate`](https://foundryvtt.com/api/classes/foundry.documents.BaseSetting.html#_preupdate)
...
Inherited from [`BaseSetting._initializationOrder`](https://foundryvtt.com/api/classes/foundry.documents.BaseSetting.html#_initializationorder)
...
Inherited from [`BaseSetting.canUserCreate`](https://foundryvtt.com/api/classes/foundry.documents.BaseSetting.html#canusercreate)
...
Inherited from [`BaseSetting.cleanData`](https://foundryvtt.com/api/classes/foundry.documents.BaseSetting.html#cleandata)
...
- `data` (optional):  
  ...
  Initial data used to create this Document(s)
...
Inherited from [`BaseSetting.create`](https://foundryvtt.com/api/classes/foundry.documents.BaseSetting.html#create)
...
- `data` (optional): Array of `object` or `Document` instances = `[]`  
- `operation` (optional): `Partial<Omit<DatabaseCreateOperation, "data">>` = `{}`
...
Inherited from [`BaseSetting.createDocuments`](https://foundryvtt.com/api/classes/foundry.documents.BaseSetting.html#createdocuments)
...
Inherited from [`BaseSetting.defineSchema`](https://foundryvtt.com/api/classes/foundry.documents.BaseSetting.html#defineschema)
...
Inherited from [`BaseSetting.deleteDocuments`](https://foundryvtt.com/api/classes/foundry.documents.BaseSetting.html#deletedocuments)
...
Inherited from [`BaseSetting.fromJSON`](https://foundryvtt.com/api/classes/foundry.documents.BaseSetting.html#fromjson)
...
Inherited from [`BaseSetting.fromSource`](https://foundryvtt.com/api/classes/foundry.documents.BaseSetting.html#fromsource)
...
Inherited from [`BaseSetting.get`](https://foundryvtt.com/api/classes/foundry.documents.BaseSetting.html#get)
...
- The provided collection name if it exists,
- The first available collection for the document name provided,
- Or `null` if no appropriate embedded collection could be found.
...
Inherited from [`BaseSetting.getCollectionName`](https://foundryvtt.com/api/classes/foundry.documents.BaseSetting.html#getcollectionname)
...
Inherited from [`BaseSetting.migrateData`](https://foundryvtt.com/api/classes/foundry.documents.BaseSetting.html#migratedata)
...
Inherited from [`BaseSetting.migrateDataSafe`](https://foundryvtt.com/api/classes/foundry.documents.BaseSetting.html#migratedatasafe)
...
Inherited from [`BaseSetting.shimData`](https://foundryvtt.com/api/classes/foundry.documents.BaseSetting.html#shimdata)
...
Inherited from [`BaseSetting.updateDocuments`](https://foundryvtt.com/api/classes/foundry.documents.BaseSetting.html#updatedocuments)
...
Inherited from [`BaseSetting.validateJoint`](https://foundryvtt.com/api/classes/foundry.documents.BaseSetting.html#validatejoint)

---

## Static Protected Batch Operations
...
- `documents`: Documents which were created
...
Inherited from [`BaseSetting._onCreateOperation`](https://foundryvtt.com/api/classes/foundry.documents.BaseSetting.html#_oncreateoperation)
...
- `documents`: Documents which were deleted
...
Inherited from [`BaseSetting._onDeleteOperation`](https://foundryvtt.com/api/classes/foundry.documents.BaseSetting.html#_ondeleteoperation)
...
- `documents`: Documents which were updated
...
Inherited from [`BaseSetting._onUpdateOperation`](https://foundryvtt.com/api/classes/foundry.documents.BaseSetting.html#_onupdateoperation)
...
**Returns**  
Promise resolving to `false` to cancel the creation operation entirely, or `void`.

Inherited from [`BaseSetting._preCreateOperation`](https://foundryvtt.com/api/classes/foundry.documents.BaseSetting.html#_precreateoperation)
...
**Returns**  
Promise resolving to `false` to cancel the deletion operation entirely, or `void`.

Inherited from [`BaseSetting._preDeleteOperation`](https://foundryvtt.com/api/classes/foundry.documents.BaseSetting.html#_predeleteoperation)
...
**Returns**  
Promise resolving to `false` to cancel the update operation entirely, or `void`.

Inherited from [`BaseSetting._preUpdateOperation`](https://foundryvtt.com/api/classes/foundry.documents.BaseSetting.html#_preupdateoperation)