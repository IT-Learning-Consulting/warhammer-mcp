# DocumentStatsField | Foundry Virtual Tabletop - API Documentation - Version 13

A subclass of [foundry.data.fields.SchemaField](https://foundryvtt.com/api/classes/foundry.data.fields.SchemaField.html) which stores document metadata in the _stats field.

Mixes:
- DocumentStats

Hierarchy ([View Summary](https://foundryvtt.com/api/hierarchy.html#foundry.data.fields.DocumentStatsField), Expand)  
- _SchemaField_  
- **DocumentStatsField**
...
Inherited from SchemaField [fieldPath](https://foundryvtt.com/api/classes/foundry.data.fields.SchemaField.html#fieldPath)
...
Inherited from [SchemaField.hasFormSupport](https://foundryvtt.com/api/classes/foundry.data.fields.SchemaField.html#hasFormSupport)
...
```typescript
_getField(path: any): undefined | DataField | DocumentStatsField
```
...
**Returns**  
`undefined | DataField | DocumentStatsField`
...
For the full module hierarchy, source code, and further details, visit the [Foundry Virtual Tabletop - API Documentation - Version 13](https://foundryvtt.com/api/classes/foundry.data.fields.DocumentStatsField.html).