# WaveColorationShader | Foundry Virtual Tabletop - API Documentation - Version 13

**Class**: `WaveColorationShader`  
Wave animation coloration shader

[Hierarchy (View Summary, Expand)](https://foundryvtt.com/api/hierarchy.html#foundry.canvas.rendering.shaders.WaveColorationShader)  
Extends: [AdaptiveColorationShader](https://foundryvtt.com/api/classes/foundry.canvas.rendering.shaders.AdaptiveColorationShader.html)
...
- **SWITCH_COLOR**  
  **Type:** `string`  
  Switch between an inner and outer color, by comparing distance from center to ratio. Apply a  
  strong gradient between the two areas if attenuation uniform is set to true.  
...
Returns: `boolean`  
Inherited from [AdaptiveColorationShader.isRequired](https://foundryvtt.com/api/classes/foundry.canvas.rendering.shaders.AdaptiveColorationShader.html)
...
- **ADJUSTMENTS**  
  ...
  Returns: `string`  
  Inherited from [AdaptiveColorationShader.ADJUSTMENTS](https://foundryvtt.com/api/classes/foundry.canvas.rendering.shaders.AdaptiveColorationShader.html)
...
- **BACKGROUND_TECHNIQUES**  
  ...
  Returns: `string`  
  Inherited from [AdaptiveColorationShader.BACKGROUND_TECHNIQUES](https://foundryvtt.com/api/classes/foundry.canvas.rendering.shaders.AdaptiveColorationShader.html)
...
- **COLORATION_TECHNIQUES**  
  ...
  Returns: `string`  
  Inherited from [AdaptiveColorationShader.COLORATION_TECHNIQUES](https://foundryvtt.com/api/classes/foundry.canvas.rendering.shaders.AdaptiveColorationShader.html)
...
- **ILLUMINATION_TECHNIQUES**  
  ...
  Returns: `string`  
  Inherited from [AdaptiveColorationShader.ILLUMINATION_TECHNIQUES](https://foundryvtt.com/api/classes/foundry.canvas.rendering.shaders.AdaptiveColorationShader.html)
...
For the full details, visit the official [Foundry Virtual Tabletop API Documentation](https://foundryvtt.com/api/classes/foundry.canvas.rendering.shaders.WaveColorationShader.html).