# Folders | Foundry Virtual Tabletop - API Documentation - Version 13
...
### See
- [foundry.documents.Folder](https://foundryvtt.com/api/classes/foundry.documents.Folder.html): The Folder document

### Hierarchy  
(View [Summary](https://foundryvtt.com/api/hierarchy.html#foundry.documents.collections.Folders), Expand)  
- _WorldCollection_  
- **Folders**
...
Overrides [WorldCollection._onModifyContents](https://foundryvtt.com/api/classes/foundry.documents.abstract.WorldCollection.html#_onmodifycontents)
