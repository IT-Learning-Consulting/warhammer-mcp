...
## Hierarchy [View Summary](https://foundryvtt.com/api/hierarchy.html#foundry.applications.api.ApplicationV2) (Expand)

- [EventEmitter](https://foundryvtt.com/api/classes/foundry.EventEmitter.html)<Function, this>
- **ApplicationV2**
...
): ApplicationV2<Configuration, RenderOptions>
```
...
- `Configuration` extends [ApplicationConfiguration](https://foundryvtt.com/api/interfaces/foundry.applications.types.ApplicationConfiguration.html) = ApplicationConfiguration
- `RenderOptions` extends [ApplicationRenderOptions](https://foundryvtt.com/api/interfaces/foundry.applications.types.ApplicationRenderOptions.html) = ApplicationRenderOptions
...
This provides a readonly view into the internal ID used by this application. This getter should not be overridden by subclasses, which should instead configure the ID in `DEFAULT_OPTIONS` or by defining a `uniqueId` during `_initializeApplicationOptions`.
...
**Yields**  
Available header control buttons.
...
**See**  
[ApplicationV2.BASE_APPLICATION](api_classes_foundry.applications.api.ApplicationV2.html.html#5)
