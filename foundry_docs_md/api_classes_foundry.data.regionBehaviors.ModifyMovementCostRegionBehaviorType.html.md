...
**Hierarchy** ([View Summary](https://foundryvtt.com/api/hierarchy.html#foundry.data.regionBehaviors.ModifyMovementCostRegionBehaviorType))
...
Overrides [RegionBehaviorType._getTerrainEffects](https://foundryvtt.com/api/classes/foundry.data.regionBehaviors.RegionBehaviorType.html#_getterraineffects)
...
Overrides [RegionBehaviorType.prepareBaseData](https://foundryvtt.com/api/classes/foundry.data.regionBehaviors.RegionBehaviorType.html#preparebasedata)
...
```typescript
defineSchema(): { difficulties: SchemaField }
```
...
### _createEventsField (protected, static)
...
- **options**: `{ events?: string[]; initial?: string[] } = {}` (Optional)  
  Options which configure how the events field is declared
  - **events**? `string[]` (Optional): The event names to restrict to.
  - **initial**? `string[]` (Optional): The initial set of events that should be default for the field
...
```typescript
events: {
    behaviorUnviewed: (...this: any, event: RegionBehaviorUnviewedEvent) => Promise<void>;
    behaviorViewed: (...this: any, event: RegionBehaviorViewedEvent) => Promise<void>;
    regionBoundary: (...this: any, event: RegionRegionBoundryEvent) => Promise<void>;
} = ...
```
