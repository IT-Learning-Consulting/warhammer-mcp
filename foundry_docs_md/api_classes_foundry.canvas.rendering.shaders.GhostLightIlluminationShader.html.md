# GhostLightIlluminationShader | Foundry Virtual Tabletop - API Documentation - Version 13

Ghost light animation illumination shader

**Hierarchy** ([View Summary](https://foundryvtt.com/api/hierarchy.html#foundry.canvas.rendering.shaders.GhostLightIlluminationShader), Expand)  
...
_For more details, visit the [Foundry Virtual Tabletop API Documentation - Version 13](https://foundryvtt.com/api/classes/foundry.canvas.rendering.shaders.GhostLightIlluminationShader.html)_