...
The singleton collection of Playlist documents which exist within the active World. This Collection is accessible within the Game object as `game.playlists`.

**See**

- [foundry.documents.Playlist: The Playlist document](https://foundryvtt.com/api/classes/foundry.documents.Playlist.html)
- [foundry.applications.sidebar.tabs.PlaylistDirectory: The PlaylistDirectory sidebar directory](https://foundryvtt.com/api/classes/foundry.applications.sidebar.tabs.PlaylistDirectory.html)

**Hierarchy** ([View Summary](https://foundryvtt.com/api/hierarchy.html#foundry.documents.collections.Playlists), Expand)
...
- **options** _(optional)_: `FromCompendiumOptions = {}`  
...
- **options** _(optional)_: `{ invalid?: boolean; strict?: boolean } = {}`  
  Additional options to configure retrieval.

  - **invalid** _(optional)_: `boolean`  
    Allow retrieving an invalid Document.

  - **strict** _(optional)_: `boolean`  
...
- **options** _(optional)_: `{ strict?: boolean } = {}`  
  Additional options to configure retrieval.
...
- **force** _(optional)_: `boolean = false`  
  Force rendering.
...
- **search**:  
  - **exclude** _(optional)_: `string[]`  
    An array of document IDs to exclude from search results.

  - **filters** _(optional)_: `FieldFilter[]`  
    An array of filters to apply.

  - **query** _(optional)_: `string`  
...
- **condition** _(optional)_: `null | Function = null`  
...
See [foundry.applications.apps.DocumentSheetConfig.registerSheet for details](https://foundryvtt.com/api/classes/foundry.applications.apps.DocumentSheetConfig.html#registersheet).
...
See [foundry.applications.apps.DocumentSheetConfig.unregisterSheet for details](https://foundryvtt.com/api/classes/foundry.applications.apps.DocumentSheetConfig.html#unregistersheet).
