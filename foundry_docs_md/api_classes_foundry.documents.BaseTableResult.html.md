...
The TableResult Document. Defines the DataSchema and common behaviors for a TableResult which are shared between both client and server.

Mixes: TableResultData

Hierarchy ([View Summary](https://foundryvtt.com/api/hierarchy.html#foundry.documents.BaseTableResult), Expand)

- [Document](https://foundryvtt.com/api/classes/foundry.abstract.Document.html)
- **BaseTableResult**
- [documents.TableResult](https://foundryvtt.com/api/classes/foundry.documents.TableResult.html)
...
```typescript
new BaseTableResult(
    data?: Partial<import("https://foundryvtt.com/api/interfaces/foundry.documents.types.TableResultData.html").TableResultData>,
...
```typescript
parent: null | import("https://foundryvtt.com/api/classes/foundry.abstract.DataModel.html").DataModel<object, import("https://foundryvtt.com/api/types/foundry.abstract.types").DataModelConstructionContext>
```
...
```typescript
static get baseDocument(): typeof import("https://foundryvtt.com/api/classes/foundry.abstract.Document.html").Document
```
...
```typescript
static get database(): import("https://foundryvtt.com/api/modules/foundry.abstract.html").abstract.DatabaseBackend
```
...
```typescript
static get implementation(): typeof import("https://foundryvtt.com/api/classes/foundry.abstract.Document.html").Document
```
...
**Returns**  
A Promise containing an array of created Document instances
...
```typescript
getEmbeddedCollection(embeddedName: string): import("https://foundryvtt.com/api/classes/foundry.abstract.Collection.html").DocumentCollection
```
...
**Returns**  
A Generator that yields embedded Documents
...
updateSource(
    changes?: object,
    options?: import("https://foundryvtt.com/api/interfaces/foundry.abstract.types.DataModelUpdateOptions.html").DataModelUpdateOptions,
): object
```
...
```typescript
_initializeSource(
    data: object | import("https://foundryvtt.com/api/classes/foundry.abstract.DataModel.html").DataModel<object, import("https://foundryvtt.com/api/types/foundry.abstract.types").DataModelConstructionContext>,
    options?: object,
): object
```
...
```typescript
static canUserCreate(user: import("https://foundryvtt.com/api/classes/foundry.documents.BaseUser.html").BaseUser): boolean
```

Test whether a given User has sufficient permissions to create Documents of this type in general.  
This does not guarantee that the User is able to create all Documents of this type, as certain document-specific requirements may also be present.
...
static create(
    data?: | object
          | import("https://foundryvtt.com/api/classes/foundry.abstract.Document.html").Document<object, import("https://foundryvtt.com/api/interfaces/foundry.abstract.types.DocumentConstructionContext.html").DocumentConstructionContext>
          | (object | import("https://foundryvtt.com/api/classes/foundry.abstract.Document.html").Document<object, import("https://foundryvtt.com/api/interfaces/foundry.abstract.types.DocumentConstructionContext.html").DocumentConstructionContext>)[],
...
static defineSchema(): {
    ...
    documentUuid: import("https://foundryvtt.com/api/classes/foundry.data.fields.DocumentUUIDField.html").DocumentUUIDField;
    ...
    img: import("https://foundryvtt.com/api/classes/foundry.data.fields.FilePathField.html").FilePathField;
    name: import("https://foundryvtt.com/api/classes/foundry.data.fields.StringField.html").StringField;
    range: import("https://foundryvtt.com/api/classes/foundry.data.fields.ArrayField.html").ArrayField<import("https://foundryvtt.com/api/classes/foundry.data.fields.NumberField.html").NumberField>;
    type: import("https://foundryvtt.com/api/classes/foundry.data.fields.DocumentTypeField.html").DocumentTypeField;
    weight: import("https://foundryvtt.com/api/classes/foundry.data.fields.NumberField.html").NumberField;
}
```
...
**Returns**  
An object representing the data schema with fields:
...
const deletedEmbedded = await Item.implementation.deleteDocuments([sword.id, shield.id], {parent: tim});

const packActor = await pack.getDocument(documentId);
const deletedInPack = await Actor.implementation.deleteDocuments([packActor.id], {pack: "mymodule.mypack"});
```
...
```typescript
static fromJSON(json: string): import("https://foundryvtt.com/api/classes/foundry.abstract.DataModel.html").DataModel<object, import("https://foundryvtt.com/api/types/foundry.abstract.types").DataModelConstructionContext>
```
...
static fromSource(
    source: object,
    context?: Omit<import("https://foundryvtt.com/api/types/foundry.abstract.types").DataModelConstructionContext, "strict"> & import("https://foundryvtt.com/api/interfaces/foundry.abstract.types").DataModelFromSourceOptions,
): import("https://foundryvtt.com/api/classes/foundry.abstract.DataModel.html").DataModel<object, import("https://foundryvtt.com/api/types/foundry.abstract.types").DataModelConstructionContext>
```
...
```typescript
const updatesSingle = [{_id: "12ekjf43kj2312ds", name: "Timothy"}];
const updatedSingle = await Actor.implementation.updateDocuments(updatesSingle);
...
Field-specific validation rules should be defined as part of the DataSchema for the model. This method allows for testing aggregate rules which impose requirements on the overall model.
