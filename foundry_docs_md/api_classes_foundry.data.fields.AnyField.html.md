# AnyField | Foundry Virtual Tabletop - API Documentation - Version 13

A special subclass of [foundry.data.fields.DataField](https://foundryvtt.com/api/classes/foundry.data.fields.DataField.html) which can contain any value of any type. Any input is accepted and is treated as valid. It is not recommended to use this class except for very specific circumstances.

## Hierarchy ([View Summary](https://foundryvtt.com/api/hierarchy.html#foundry.data.fields.AnyField), Expand)
...
Protected. Default parameters for this field type.
...
- **options** (_optional_): `{ partial?: boolean; source?: object } = {}`  
  Additional options for how the field is cleaned

  - **partial** (_optional_): `boolean`  
    Whether to perform partial cleaning?

  - **source** (_optional_): `object`  
...
- **options** (_optional_): `DataFieldValidationOptions = {}`  
...
*Inherited from [DataField._cast](https://foundryvtt.com/api/classes/foundry.data.fields.DataField.html#_cast)*
