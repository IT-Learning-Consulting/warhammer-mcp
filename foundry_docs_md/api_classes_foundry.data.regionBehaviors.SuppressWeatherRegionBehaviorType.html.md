...
[regionBehaviors](https://foundryvtt.com/api/modules/foundry.data.regionBehaviors.html) /
...
- **behaviorUnviewed**:  
  `(...this: any, event: RegionBehaviorUnviewedEvent) => Promise<void>`

- **behaviorViewed**:  
  `(...this: any, event: RegionBehaviorViewedEvent) => Promise<void>`
