# HTMLField | Foundry Virtual Tabletop - API Documentation - Version 13

A subclass of [foundry.data.fields.StringField](https://foundryvtt.com/api/classes/foundry.data.fields.StringField.html) which contains a sanitized HTML string. This class does not override any StringField behaviors, but is used by the server-side to identify fields which require sanitization of user input.

**Hierarchy** ([View Summary](https://foundryvtt.com/api/hierarchy.html#foundry.data.fields.HTMLField), Expand)
...
**Returns**  
`DataFieldOptions & { blank: boolean; choices: undefined; textSearch: boolean; trim: boolean; } & { blank: boolean; required: boolean }`
...
Inherited from [StringField.hasFormSupport](https://foundryvtt.com/api/classes/foundry.data.fields.StringField.html#hasformsupport)
...
Inherited from [_StringField._cast](https://foundryvtt.com/api/classes/foundry.data.fields.StringField.html#_cast)
...
Overrides [_StringField._toInput](https://foundryvtt.com/api/classes/foundry.data.fields.StringField.html#_toinput)
...
Inherited from [_StringField._validateSpecial](https://foundryvtt.com/api/classes/foundry.data.fields.StringField.html#_validatespecial)
...
Inherited from [_StringField._validateType](https://foundryvtt.com/api/classes/foundry.data.fields.StringField.html#_validatetype)
...
For full documentation, see the [Foundry Virtual Tabletop API Documentation](https://foundryvtt.com/api/classes/foundry.data.fields.HTMLField.html) for **HTMLField**.