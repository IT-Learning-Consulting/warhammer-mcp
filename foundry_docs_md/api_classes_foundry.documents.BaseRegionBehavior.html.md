# BaseRegionBehavior | Foundry Virtual Tabletop - API Documentation - Version 13

The RegionBehavior Document. Defines the DataSchema and common behaviors for a  
RegionBehavior which are shared between both client and server.

Mixes:  
**RegionBehaviorData**

Hierarchy [(View Summary)](https://foundryvtt.com/api/hierarchy.html#foundry.documents.BaseRegionBehavior), Expand:  
- <i>[Document](https://foundryvtt.com/api/classes/foundry.abstract.Document.html)</i>  
- **BaseRegionBehavior**  
- <i>[documents.RegionBehavior](https://foundryvtt.com/api/classes/foundry.documents.RegionBehavior.html)</i>
...
**Returns**  
`boolean` — Whether the data source or proposed change is reported as valid. A boolean is always  
...
**Returns**  
`null | string` — The provided collection name if it exists, the first available collection for the document name  
...
document instances using `updateSource`.
...
View the full [BaseRegionBehavior API Documentation (Foundry VTT)](https://foundryvtt.com/api/classes/foundry.documents.BaseRegionBehavior.html)