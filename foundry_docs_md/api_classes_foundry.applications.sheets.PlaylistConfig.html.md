...
**Hierarchy** ([View Summary](https://foundryvtt.com/api/hierarchy.html#foundry.applications.sheets.PlaylistConfig)):  
...
**Returns:**  
`Promise<ApplicationRenderContext & { document, editable, fields, rootId, source, user } & { buttons, channels, milliseconds, modes, sortModes }>`
...
```typescript
close(options?: Partial<ApplicationClosingOptions>): Promise<PlaylistConfig>
```
...
- **options?**: `Partial<DatabaseUpdateOperation | DatabaseCreateOperation>` (optional)  
...
- [Hierarchy Summary](https://foundryvtt.com/api/hierarchy.html#foundry.applications.sheets.PlaylistConfig)
...
- [ContextMenuEntry](https://foundryvtt.com/api/classes/foundry.applications.ux.ContextMenu.html#ContextMenuEntry)
