# BewitchingWaveIlluminationShader | Foundry Virtual Tabletop - API Documentation - Version 13

**Class** `BewitchingWaveIlluminationShader`  
Bewitching Wave animation illumination shader

Hierarchy ([View Summary](https://foundryvtt.com/api/hierarchy.html#foundry.canvas.rendering.shaders.BewitchingWaveIlluminationShader), Expand)
...
For full details, visit the [Foundry Virtual Tabletop API Documentation](https://foundryvtt.com/api/classes/foundry.canvas.rendering.shaders.BewitchingWaveIlluminationShader.html).