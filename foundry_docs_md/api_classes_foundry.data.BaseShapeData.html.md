# BaseShapeData | Foundry Virtual Tabletop - API Documentation - Version 13
...
- [DataModel](https://foundryvtt.com/api/classes/foundry.abstract.DataModel.html)  
  - **BaseShapeData**  
    - [RectangleShapeData](https://foundryvtt.com/api/classes/foundry.data.RectangleShapeData.html)  
    - [CircleShapeData](https://foundryvtt.com/api/classes/foundry.data.CircleShapeData.html)  
    - [EllipseShapeData](https://foundryvtt.com/api/classes/foundry.data.EllipseShapeData.html)  
    - [PolygonShapeData](https://foundryvtt.com/api/classes/foundry.data.PolygonShapeData.html)
...
- **options**: `DataModelConstructionContext` = `{}` (Optional)  
...
**Returns**  
The document source data expressed as a plain object (`object`).
...
Protected method to configure the data model instance before validation and initialization workflows are performed.
...
Protected method to initialize the instance by copying data from the source object to instance attributes. Mirrors the workflow of [`SchemaField#initialize`](https://foundryvtt.com/api/classes/foundry.data.fields.SchemaField.html#initialize) but with some added functionality.
...
Protected method to initialize the source data for a new DataModel instance. One-time migrations and initial cleaning operations are applied to the source data.
...
**Returns**  
Migrated and cleaned source data which will be stored to the model instance (the same object as the `data` argument).
...
**Returns**  
The cleaned source data (the same object as the `source` argument).
...
Overrides `DataModel.defineSchema`.
...
**Returns**  
Migrated source data (the same object as the `source` argument).
...
**Returns**  
Data with added backwards-compatible properties (the same object as the `data` argument).
