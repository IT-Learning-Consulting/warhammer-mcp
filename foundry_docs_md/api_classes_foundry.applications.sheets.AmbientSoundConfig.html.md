...
## Hierarchy ([View Summary](https://foundryvtt.com/api/hierarchy.html#foundry.applications.sheets.AmbientSoundConfig))
...
`options: Readonly<import("https://foundryvtt.com/api/interfaces/foundry.applications.types.ApplicationConfiguration.html").ApplicationConfiguration & import("https://foundryvtt.com/api/interfaces/foundry.DocumentSheetConfiguration.html").DocumentSheetConfiguration>`
...
`position: import("https://foundryvtt.com/api/interfaces/foundry.applications.types.ApplicationPosition.html").ApplicationPosition = ...`
...
`BASE_APPLICATION: typeof import("https://foundryvtt.com/api/classes/foundry.applications.api.ApplicationV2.html").ApplicationV2 = ApplicationV2`
...
Static property describing default options for the Application.

### emittedEvents

`static emittedEvents: readonly ["render", "close", "position"]`

Emitted events by this Application.

### PARTS

`static PARTS: { body: { template: string }; footer: { template: string } }`

Static parts templates for the Application.
...
`static TABS: Record<string, import("https://foundryvtt.com/api/interfaces/foundry.applications.types.ApplicationTabsConfiguration.html").ApplicationTabsConfiguration> = {}`
...
This provides a readonly view into the internal ID used by this application. This getter should not be overridden by subclasses,  
...
get window(): {
    ...
    pointerStartPosition: import("https://foundryvtt.com/api/interfaces/foundry.applications.types.ApplicationPosition.html").ApplicationPosition;
    resize: HTMLElement;
...
```typescript
_headerControlButtons(): Generator<import("https://foundryvtt.com/api/interfaces/foundry.applications.types.ApplicationHeaderControlsEntry.html").ApplicationHeaderControlsEntry, void, unknown>
```
...
_prepareContext(
    ...
    import("https://foundryvtt.com/api/interfaces/foundry.applications.types.ApplicationRenderContext.html").ApplicationRenderContext &
    {
        ...
        rootId: string;
        source: any;
        user: null | import("https://foundryvtt.com/api/modules/foundry.documents.html").User;
    } & {
...
**Returns:**  
`Promise<ApplicationRenderContext & {document: ClientDocument; editable: boolean; fields: any; rootId: string; source: any; user: User | null;} & {buttons, gridUnits, sound, soundEffects}>`  
...
```typescript
_renderHTML(
    context: import("https://foundryvtt.com/api/interfaces/foundry.applications.types.ApplicationRenderContext.html").ApplicationRenderContext,
    options: import("https://foundryvtt.com/api/interfaces/foundry.applications.types.ApplicationRenderOptions.html").ApplicationRenderOptions & import("https://foundryvtt.com/api/interfaces/foundry.DocumentSheetRenderOptions.html").DocumentSheetRenderOptions,
): Promise<any>
```
...
addEventListener(
    type: string,
    listener: import("https://foundryvtt.com/api/types/foundry.utils.types.EmittedEventListener.html").EmittedEventListener,
...
Once ApplicationV1 is deprecated, switch from _maxZ to ApplicationV2#maxZ.  
Also eliminate ui.activeWindow in favor of only ApplicationV2#frontApp.
...
```typescript
close(options?: Partial<import("https://foundryvtt.com/api/interfaces/foundry.applications.types.ApplicationClosingOptions.html").ApplicationClosingOptions>): Promise<AmbientSoundConfig>
```
...
```typescript
removeEventListener(type: string, listener: import("https://foundryvtt.com/api/types/foundry.utils.types.EmittedEventListener.html").EmittedEventListener): void
```
...
```typescript
render(
    options?: boolean | (import("https://foundryvtt.com/api/interfaces/foundry.applications.types.ApplicationRenderOptions.html").ApplicationRenderOptions & import("https://foundryvtt.com/api/interfaces/foundry.DocumentSheetRenderOptions.html").DocumentSheetRenderOptions),
    _options?: import("https://foundryvtt.com/api/interfaces/foundry.applications.types.ApplicationRenderOptions.html").ApplicationRenderOptions & import("https://foundryvtt.com/api/interfaces/foundry.DocumentSheetRenderOptions.html").DocumentSheetRenderOptions,
): Promise<AmbientSoundConfig>
```
...
**Parameters:**
- **options?**: `boolean` or `ApplicationRenderOptions & DocumentSheetRenderOptions`  
...
```typescript
setPosition(position?: Partial<import("https://foundryvtt.com/api/interfaces/foundry.applications.types.ApplicationPosition.html").ApplicationPosition>): void | import("https://foundryvtt.com/api/interfaces/foundry.applications.types.ApplicationPosition.html").ApplicationPosition
```
...
_protected _createContextMenu(
    handler: () => import("ContextMenuEntry").ContextMenuEntry[],
    selector: string,
    options?: {
...
): null | import("https://foundryvtt.com/api/classes/foundry.applications.ux.ContextMenu.html").ContextMenu
```
...
```typescript
_protected _getHeaderControls(): import("https://foundryvtt.com/api/interfaces/foundry.applications.types.ApplicationHeaderControlsEntry.html").ApplicationHeaderControlsEntry[]
```
...
```typescript
_protected _getTabsConfig(group: string): null | import("https://foundryvtt.com/api/interfaces/foundry.applications.types.ApplicationTabsConfiguration.html").ApplicationTabsConfiguration
```
...
Action handlers defined in `DEFAULT_OPTIONS` are called first.  
...
```typescript
_protected _onPosition(position: import("https://foundryvtt.com/api/interfaces/foundry.applications.types.ApplicationPosition.html").ApplicationPosition): void
```
...
_protected _onSubmitForm(
    formConfig: import("https://foundryvtt.com/api/interfaces/foundry.applications.types.ApplicationFormConfiguration.html").ApplicationFormConfiguration,
...
_protected _prepareSubmitData(
    ...
    formData: import("https://foundryvtt.com/api/classes/foundry.applications.ux.FormDataExtended.html").FormDataExtended,
    updateData?: object,
): object
```
...
```typescript
_protected _prepareTabs(group: string): Record<string, import("https://foundryvtt.com/api/interfaces/foundry.applications.types.ApplicationTab.html").ApplicationTab>
```
...
```typescript
_protected _prePosition(position: import("https://foundryvtt.com/api/interfaces/foundry.applications.types.ApplicationPosition.html").ApplicationPosition): void
```
...
```typescript
_protected _processSubmitData(
    event: SubmitEvent,
    form: HTMLFormElement,
    submitData: object,
    options?: Partial<import("https://foundryvtt.com/api/interfaces/foundry.abstract.types.DatabaseUpdateOperation.html").DatabaseUpdateOperation | import("https://foundryvtt.com/api/interfaces/foundry.abstract.types.DatabaseCreateOperation.html").DatabaseCreateOperation>,
): Promise<void>
```
...
```typescript
_protected _renderHeaderControl(control: import("https://foundryvtt.com/api/interfaces/foundry.applications.types.ApplicationHeaderControlsEntry.html").ApplicationHeaderControlsEntry): HTMLLIElement
```
...
```typescript
_protected _tearDown(options: import("https://foundryvtt.com/api/interfaces/foundry.applications.types.ApplicationClosingOptions.html").ApplicationClosingOptions): void
```
...
```typescript
_protected _updatePosition(position: import("https://foundryvtt.com/api/interfaces/foundry.applications.types.ApplicationPosition.html").ApplicationPosition): import("https://foundryvtt.com/api/interfaces/foundry.applications.types.ApplicationPosition.html").ApplicationPosition
```
...
```typescript
static inheritanceChain(): Generator<typeof import("https://foundryvtt.com/api/classes/foundry.applications.api.ApplicationV2.html").ApplicationV2, void, unknown>
```
