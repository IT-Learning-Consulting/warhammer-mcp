# RollTables | Foundry Virtual Tabletop - API Documentation - Version 13
...
- [foundry.documents.RollTable: The RollTable document](https://foundryvtt.com/api/classes/foundry.documents.RollTable.html)
- [foundry.applications.sidebar.tabs.RollTableDirectory: The RollTableDirectory sidebar directory](https://foundryvtt.com/api/classes/foundry.applications.sidebar.tabs.RollTableDirectory.html)

## Hierarchy ([View Summary](https://foundryvtt.com/api/hierarchy.html#foundry.documents.collections.RollTables), Expand)

- [WorldCollection](https://foundryvtt.com/api/classes/foundry.documents.abstract.WorldCollection.html)
- **RollTables**
...
Returns `V[]`  
Inherited from [WorldCollection.contents](https://foundryvtt.com/api/classes/foundry.documents.abstract.WorldCollection.html#contents)
...
Returns `any`  
Inherited from [WorldCollection.documentName](https://foundryvtt.com/api/classes/foundry.documents.abstract.WorldCollection.html#documentName)
...
Inherited from [WorldCollection.folders](https://foundryvtt.com/api/classes/foundry.documents.abstract.WorldCollection.html#folders)
...
- **options**?: `object = {}`  
  Optional arguments passed to the [WorldCollection.fromCompendium](https://foundryvtt.com/api/classes/foundry.documents.abstract.WorldCollection.html#fromCompendium) and  
...
See [DocumentSheetConfig.registerSheet for details](https://foundryvtt.com/api/classes/foundry.applications.apps.DocumentSheetConfig.html#registerSheet).
...
See [DocumentSheetConfig.unregisterSheet for details](https://foundryvtt.com/api/classes/foundry.applications.apps.DocumentSheetConfig.html#unregisterSheet).
