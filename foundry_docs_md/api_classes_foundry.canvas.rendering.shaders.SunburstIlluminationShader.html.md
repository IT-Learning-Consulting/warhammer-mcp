...
Part of [foundry.canvas.rendering.shaders](https://foundryvtt.com/api/modules/foundry.canvas.rendering.shaders.html).
...
- Type: `string`  
- Description: Overrides AdaptiveIlluminationShader.fragmentShader
...
- [AdaptiveIlluminationShader Class](https://foundryvtt.com/api/classes/foundry.canvas.rendering.shaders.AdaptiveIlluminationShader.html)
