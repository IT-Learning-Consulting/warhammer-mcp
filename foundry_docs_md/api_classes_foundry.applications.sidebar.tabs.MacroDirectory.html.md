...
See also the hierarchy at [View Summary](https://foundryvtt.com/api/hierarchy.html#foundry.applications.sidebar.tabs.MacroDirectory)
...
### options
Type: `Readonly<[DocumentDirectoryConfiguration](https://foundryvtt.com/api/types/foundry.DocumentDirectoryConfiguration.html)>`
...
Type: `typeof [ApplicationV2](https://foundryvtt.com/api/classes/foundry.applications.api.ApplicationV2.html) = ApplicationV2`

Designates which upstream Application class in this class' inheritance chain is the base  
application. Any DEFAULT_OPTIONS of super-classes further upstream of the BASE_APPLICATION  
are ignored. Hook events for super-classes further upstream of the BASE_APPLICATION are not dispatched.  
...
### _entryPartial (protected static)
...
### _folderPartial (protected static)
...
- **options**: [HandlebarsRenderOptions](https://foundryvtt.com/api/interfaces/foundry.HandlebarsRenderOptions.html) — Options which configure application rendering behavior  
...
### close
```typescript
close(options?: Partial<ApplicationClosingOptions>): Promise<MacroDirectory>
```
...
**Returns**  
`Promise<MacroDirectory>` — A Promise which resolves to the closed Application instance
...
```typescript
_createDroppedEntry(entry: DirectoryMixinEntry, updates?: object): Promise<documents.Macro>
```
...
_createDroppedFolderDocuments(
  folder: documents.Folder,
  documents: object[] | documents.Macro[],
): Promise<void>
```
...
### _getEntryContextOptions (protected)
```typescript
...
### _getFolderContextOptions (protected)
```typescript
...
_organizeDroppedFoldersAndDocuments(
  ...
  documentsToCreate: object[] | documents.Macro[];
...
**Parameters**  
- **options**: [HandlebarsRenderOptions](https://foundryvtt.com/api/interfaces/foundry.HandlebarsRenderOptions.html) — Provided render options
...
**Parameters**  
- **context**: [ApplicationRenderContext](https://foundryvtt.com/api/interfaces/foundry.applications.types.ApplicationRenderContext.html) — Prepared context data  
- **options**: [HandlebarsRenderOptions](https://foundryvtt.com/api/interfaces/foundry.HandlebarsRenderOptions.html) — Provided render options
...
**Parameters**  
- **options**: [HandlebarsRenderOptions](https://foundryvtt.com/api/interfaces/foundry.HandlebarsRenderOptions.html) — Options provided at render-time
...
- [Foundry Virtual Tabletop API Documentation - Version 13](https://foundryvtt.com/api/index.html)
- [DocumentDirectory class](https://foundryvtt.com/api/classes/foundry.applications.sidebar.DocumentDirectory.html)
- [ApplicationV2 class](https://foundryvtt.com/api/classes/foundry.applications.api.ApplicationV2.html)
- [AbstractSidebarTab class](https://foundryvtt.com/api/classes/foundry.applications.sidebar.AbstractSidebarTab.html)
...
- [Macro class](https://foundryvtt.com/api/classes/foundry.documents.Macro.html)
- [Folder class](https://foundryvtt.com/api/classes/foundry.documents.Folder.html)