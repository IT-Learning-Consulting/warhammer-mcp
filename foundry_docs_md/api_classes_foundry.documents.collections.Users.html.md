# Users | Foundry Virtual Tabletop - API Documentation - Version 13
...
- [hookEvents.userConnected](https://foundryvtt.com/api/functions/hookEvents.userConnected.html)

---

## See Also

- [foundry.documents.User: The User document](https://foundryvtt.com/api/classes/foundry.documents.User.html)

---

## Hierarchy  
(View [Summary](https://foundryvtt.com/api/hierarchy.html#foundry.documents.collections.Users))  
Expand
...
Inherited from [WorldCollection.directory](https://foundryvtt.com/api/classes/foundry.documents.abstract.WorldCollection.html#directory)
...
Overrides [WorldCollection._initialize](https://foundryvtt.com/api/classes/foundry.documents.abstract.WorldCollection.html#_initialize)
...
When iterating over a Collection, we should iterate over its values rather than its entries.
...
Get the designated User among the Users that satisfy the given condition. Returns `null` if no Users satisfy the condition. Returns a User with the highest role among the qualifying Users. Qualifying Users aren't necessarily active unless it is part of the condition.
...
**Returns:**  
`any`  
The retrieved entry value if found, otherwise undefined.
