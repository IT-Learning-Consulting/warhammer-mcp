...
**Hierarchy:**  
[View Summary](https://foundryvtt.com/api/hierarchy.html#foundry.applications.sheets.RegionConfig)  
...
DEFAULT_OPTIONS: {
    actions: {
        ...
        behaviorDelete: (...this: any, event: PointerEvent) => Promise<void>;
        behaviorEdit: (...this: any, event: PointerEvent) => Promise<void>;
        behaviorToggle: (...this: any, event: PointerEvent) => Promise<void>;
        shapeCreateFromWalls: (...this: any, event: PointerEvent) => Promise<void>;
        shapeMoveDown: (...this: any, event: PointerEvent) => Promise<void>;
        shapeMoveUp: (...this: any, event: PointerEvent) => Promise<void>;
        shapeRemove: (...this: any, event: PointerEvent) => Promise<any>;
        shapeToggleHole: (...this: any, event: PointerEvent) => Promise<void>;
    };
    classes: string[];
...
```typescript
PARTS: {
    behaviors: { scrollable: string[]; template: string };
    footer: { template: string };
    identity: { template: string };
    shapes: { scrollable: string[]; template: string };
...
> [ClientDocument](https://foundryvtt.com/api/modules/foundry.documents.html)  
...
```typescript
close(options?: Partial<ApplicationClosingOptions>): Promise<RegionConfig>
```
...
> Inherited from HandlebarsApplicationMixin(DocumentSheetV2)._canDragDrop
...
> Inherited from HandlebarsApplicationMixin(DocumentSheetV2)._canDragStart
...
> Inherited from HandlebarsApplicationMixin(DocumentSheetV2)._onDragOver
...
> Inherited from HandlebarsApplicationMixin(DocumentSheetV2)._onDragStart
...
> Inherited from HandlebarsApplicationMixin(DocumentSheetV2)._onDrop
