# CircleShapeData | Foundry Virtual Tabletop - API Documentation - Version 13

The data model for a circle shape.

## Hierarchy  
[View Summary](https://foundryvtt.com/api/hierarchy.html#foundry.data.CircleShapeData), Expand
...
**Returns**  
`Readonly<{ circle: CircleShapeData; ellipse: EllipseShapeData; polygon: PolygonShapeData; rectangle: RectangleShapeData; }>`
...
static defineSchema(): 
    ...
    { radius: NumberField; x: NumberField; y: NumberField; }
```
...
- **radius**: [`NumberField`](https://foundryvtt.com/api/classes/foundry.data.fields.NumberField.html)  
