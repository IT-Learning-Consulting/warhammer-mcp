# BaseTerrainData | Foundry Virtual Tabletop - API Documentation - Version 13

**Class** `BaseTerrainData<TerrainEffect>`  
*Abstract*  
...
## Hierarchy
- [DataModel](https://foundryvtt.com/api/classes/foundry.abstract.DataModel.html) (i)
- **BaseTerrainData**
- [TerrainData](https://foundryvtt.com/api/classes/foundry.data.TerrainData.html) (i)
...
```typescript
new BaseTerrainData<TerrainEffect>(
    data?: object,
...
*Inherited from [DataModel](https://foundryvtt.com/api/classes/foundry.abstract.DataModel.html#_source)*
...
*Inherited from [DataModel](https://foundryvtt.com/api/classes/foundry.abstract.DataModel.html#parent)*
...
*Inherited from [DataModel](https://foundryvtt.com/api/classes/foundry.abstract.DataModel.html#localization_prefixes)*
...
Returns `boolean`.  
*Inherited from [DataModel.invalid](https://foundryvtt.com/api/classes/foundry.abstract.DataModel.html#invalid)*
...
Returns `SchemaField`.  
*Inherited from [DataModel.schema](https://foundryvtt.com/api/classes/foundry.abstract.DataModel.html#schema)*
...
Returns an object with the structure shown above.  
*Inherited from [DataModel.validationFailures](https://foundryvtt.com/api/classes/foundry.abstract.DataModel.html#validationFailures)*
...
**Returns**  
- `boolean` Are the terrain datas equal?
...
### static getMovementCostFunction (abstract)
...
### static resolveTerrainEffects (abstract)

```typescript
static resolveTerrainEffects(
    effects: TerrainEffect[],
): null | BaseTerrainData<TerrainEffect>
```

Create the terrain data from the given array of terrain effects. The type of the terrain effects and data is system-defined. The terrain effects are not passed in any particular order. Ownership of the array is passed to this function. This function must return null if the array of terrain effects is empty.
...
**Returns**  
- `null | BaseTerrainData<TerrainEffect>` The terrain data or null.
...
### static _initializationOrder (protected)
