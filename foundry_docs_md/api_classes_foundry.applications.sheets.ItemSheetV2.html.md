# ItemSheetV2 | Foundry Virtual Tabletop - API Documentation - Version 13

A base class for providing Item Sheet behavior using ApplicationV2.

## Hierarchy  
[View Summary](https://foundryvtt.com/api/hierarchy.html#foundry.applications.sheets.ItemSheetV2)  
- _DocumentSheetV2_  
- **ItemSheetV2**
...
```typescript
DEFAULT_OPTIONS: { position: { width: number } } = ...
```
...
- **options?**  
  ...
  `"force"` option.  
  Type: `boolean | ApplicationRenderOptions & DocumentSheetRenderOptions = {}`
- **_options?**  
