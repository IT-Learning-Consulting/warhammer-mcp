# BaseCombat | Foundry Virtual Tabletop - API Documentation - Version 13

The Combat Document. Defines the DataSchema and common behaviors for a Combat which are shared between both client and server.
...
- **BaseCombat**  
- [documents.Combat](https://foundryvtt.com/api/classes/foundry.documents.Combat.html)
...
**Returns**: `Document<object, DocumentConstructionContext>` | `undefined`  
...
**Returns**: Object describing the fields of the schema
