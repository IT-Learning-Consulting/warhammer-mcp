# LightingLayer | Foundry Virtual Tabletop - API Documentation - Version 13
...
## Hierarchy  
[View Summary](https://foundryvtt.com/api/hierarchy.html#foundry.canvas.layers.LightingLayer)  
...
Note: Override this getter if `hookName` should not return the class constructor name.  
Returns: `string`  
...
- **Returns:** `void`  
Inherited from [PlaceablesLayer.refreshFields](https://foundryvtt.com/api/classes/foundry.canvas.layers.PlaceablesLayer.html#refreshFields).
...
[PlaceablesLayer#_storeHistory](https://foundryvtt.com/api/classes/foundry.canvas.layers.PlaceablesLayer.html#_storeHistory) without passing the given options.  
Subclasses may override this function and can call PlaceablesLayer#_storeHistory themselves to pass options as needed.
...
prepareSceneControls(): {
    ...
    tools: {
        ...
        day: {
            ...
            icon: string;
            name: string;
            onChange: () => Promise<undefined | Document<object, DocumentConstructionContext>>;
            order: number;
            title: string;
            toolclip: {
                heading: string;
...
[Foundry Virtual Tabletop - API Documentation - Version 13](https://foundryvtt.com/api/classes/foundry.canvas.layers.LightingLayer.html)