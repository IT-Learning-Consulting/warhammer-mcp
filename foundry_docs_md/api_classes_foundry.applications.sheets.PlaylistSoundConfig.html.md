# PlaylistSoundConfig | Foundry Virtual Tabletop - API Documentation - Version 13
...
**Hierarchy** ([View Summary](https://foundryvtt.com/api/hierarchy.html#foundry.applications.sheets.PlaylistSoundConfig), Expand)
...
application. Any DEFAULT_OPTIONS of super-classes further upstream of the BASE_APPLICATION are ignored. Hook events for super-classes further upstream of the BASE_APPLICATION are not dispatched.
...
For more details, visit the [PlaylistSoundConfig class documentation](https://foundryvtt.com/api/classes/foundry.applications.sheets.PlaylistSoundConfig.html).