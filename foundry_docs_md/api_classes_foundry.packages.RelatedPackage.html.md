...
- Hierarchy: [View Summary](https://foundryvtt.com/api/hierarchy.html#foundry.packages.RelatedPackage)

Inherits from: [SchemaField](https://foundryvtt.com/api/classes/foundry.data.fields.SchemaField.html)
...
```typescript
_getField(path: any): undefined | DataField | RelatedPackage
```
...
**Returns:** `undefined | DataField | RelatedPackage`
...
**Returns:** `undefined | DataModelValidationFailure`
...
For full documentation, visit [Foundry Virtual Tabletop - API Documentation - Version 13](https://foundryvtt.com/api/classes/foundry.packages.RelatedPackage.html)