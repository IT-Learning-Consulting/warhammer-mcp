# WorldSettings | Foundry Virtual Tabletop - API Documentation - Version 13
...
**See:**  
[foundry.documents.Setting: The Setting document](https://foundryvtt.com/api/classes/foundry.documents.Setting.html)

**Hierarchy ([View Summary](https://foundryvtt.com/api/hierarchy.html#foundry.documents.collections.WorldSettings), Expand)**  
...
Returns `null`. Overrides WorldCollection.directory
...
Returns `any`. Inherited from WorldCollection.documentName
...
`void | Document<object, DocumentConstructionContext>` - An in-memory instance for the invalid Document
...
`null | string` - The serialized setting string
...
`Setting`  
[Setting document class](https://foundryvtt.com/api/classes/foundry.documents.Setting.html)
...
Protected method. Initialize the DocumentCollection by constructing any initially provided Document instances.
