# WaveBackgroundVisionShader | Foundry Virtual Tabletop - API Documentation - Version 13
...
**Returns:** `string`  
Inherited from `BackgroundVisionShader.BACKGROUND_TECHNIQUES`
...
**Returns:** `string`  
Inherited from `BackgroundVisionShader.COLORATION_TECHNIQUES`
...
**Returns:** `string`  
Inherited from `BackgroundVisionShader.ILLUMINATION_TECHNIQUES`
...
For further details, visit the [Foundry Virtual Tabletop API Documentation](https://foundryvtt.com/api/modules/foundry.canvas.rendering.shaders.WaveBackgroundVisionShader.html).