# PackageRelationships | Foundry Virtual Tabletop - API Documentation - Version 13
...
Hierarchy: [View Summary](https://foundryvtt.com/api/hierarchy.html#foundry.PackageRelationships)  
...
Overrides `SchemaField.constructor`.
...
**Returns**  
[DataFieldOptions](https://foundryvtt.com/api/interfaces/foundry.data.types.DataFieldOptions.html) & { nullable: boolean; required: boolean }
...
```typescript
_getField(path: any): undefined | DataField | PackageRelationships
```
...
**Returns**  
`undefined` | [DataField](https://foundryvtt.com/api/classes/foundry.data.fields.DataField.html) | [PackageRelationships](https://foundryvtt.com/api/classes/foundry.PackageRelationships.html)
...
**Returns**  
`boolean` - Does the named field exist in this schema?
