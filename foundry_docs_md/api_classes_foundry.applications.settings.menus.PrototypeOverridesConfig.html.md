...
## Hierarchy  
[ApplicationV2< ApplicationConfiguration, ApplicationRenderOptions, this >](https://foundryvtt.com/api/classes/foundry.applications.api.ApplicationV2.html)  
↳ PrototypeOverridesConfig
...
_prepareContext(
    ...
    booleanOptions: { false: string; true: string };
    buttons: FormFooterButton[];
    displayModes: any;
    dispositions: any;
    rootId: string;
    tabs: Record<string, ApplicationTab>;
    turnMarkerAnimations: { label: string; value: string }[];
    turnMarkerModes: any;
