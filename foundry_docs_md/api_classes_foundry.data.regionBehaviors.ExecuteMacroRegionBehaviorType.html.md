...
**Inherit Doc:** Inherited from [RegionBehaviorType.constructor](https://foundryvtt.com/api/classes/foundry.data.regionBehaviors.RegionBehaviorType.html#constructor)
...
`events: Record<string, (this: RegionBehaviorType, event: RegionEvent) => Promise<void>> = {}`
...
### _getTerrainEffects (Protected)

```typescript
_getTerrainEffects<TerrainEffect>(
    token: TokenDocument,
...
### Static Protected: _createEventsField
