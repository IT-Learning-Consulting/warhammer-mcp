# BaseJournalEntryPage | Foundry Virtual Tabletop - API Documentation - Version 13

The JournalEntryPage Document. Defines the DataSchema and common behaviors for a JournalEntryPage which are shared between both client and server.

## Mixes

- JournalEntryPageData

## Hierarchy ([View Summary](https://foundryvtt.com/api/hierarchy.html#foundry.documents.BaseJournalEntryPage), Expand)

- [Document](https://foundryvtt.com/api/classes/foundry.abstract.Document.html)
- **BaseJournalEntryPage**
- [documents.JournalEntryPage](https://foundryvtt.com/api/classes/foundry.documents.JournalEntryPage.html)
...
- `data` (Optional): `Partial<JournalEntryPageData>` = `{}`  
...
**Returns**  
Promise of an array of updated Document instances
...
### Protected Lifecycle Hooks for Pre-Operation Events
...
**Returns**  
Promise resolving to `false` to exclude this Document from the creation operation or void.
...
**Returns**  
Promise resolving to false indicates the deletion operation should be cancelled; otherwise void.
...
**Returns**  
Promise resolving to false indicates the update operation should be cancelled; otherwise void.
...
**Returns**  
Generator yielding arrays of any type.
