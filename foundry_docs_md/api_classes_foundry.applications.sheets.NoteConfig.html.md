# NoteConfig | Foundry Virtual Tabletop - API Documentation - Version 13
...
## Hierarchy  
[View Summary](https://foundryvtt.com/api/hierarchy.html#foundry.applications.sheets.NoteConfig), Expand
...
_prepareContext(
    ...
    ApplicationRenderContext & {
        ...
        entries: { label: any; value: any }[];
        entry: Document<object, DocumentConstructionContext>;
        fontFamilies: Record<string, string>;
        global: any;
        gridUnits: any;
        icon: { custom: string; selected: string };
