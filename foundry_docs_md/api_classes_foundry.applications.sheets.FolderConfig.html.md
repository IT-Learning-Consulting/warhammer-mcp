# FolderConfig | Foundry Virtual Tabletop - API Documentation - Version 13
...
**Hierarchy** ([View Summary](https://foundryvtt.com/api/hierarchy.html#foundry.applications.sheets.FolderConfig))
...
```typescript
close(options?: Partial<ApplicationClosingOptions>): Promise<FolderConfig>
```
