...
The Setting Document. Defines the DataSchema and common behaviors for a Setting which are shared between both client and server.

Mixes: `SettingData`

Hierarchy [(View Summary)](https://foundryvtt.com/api/hierarchy.html#foundry.documents.BaseSetting), Expand
...
const data = [{ name: "Sword", type: "weapon" }, { name: "Shield", type: "armor" }];
