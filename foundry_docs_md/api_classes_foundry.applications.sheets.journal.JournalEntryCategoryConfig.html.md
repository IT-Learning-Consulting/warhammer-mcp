# JournalEntryCategoryConfig | Foundry Virtual Tabletop - API Documentation - Version 13
...
**Hierarchy** ([View Summary](https://foundryvtt.com/api/hierarchy.html#foundry.applications.sheets.journal.JournalEntryCategoryConfig))  
...
DEFAULT_OPTIONS: {
    actions: {
        addCategory: (...this: any) => Promise<documents.JournalEntryCategory>;
        removeCategory: (
            ...this: any,
            event: PointerEvent,
            target: HTMLElement,
        ) => Promise<documents.JournalEntryCategory>;
        sortDown: (
            ...this: any,
            event: PointerEvent,
            target: HTMLElement,
...
Inherited from HandlebarsApplicationMixin(DocumentSheetV2)._renderHTML (abstract)
