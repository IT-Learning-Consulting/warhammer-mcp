...
Part of the [foundry.canvas.rendering.shaders](https://foundryvtt.com/api/modules/foundry.canvas.rendering.shaders.html) namespace in Foundry Virtual Tabletop - API Documentation - Version 13.

This class extends the [AdaptiveColorationShader](https://foundryvtt.com/api/classes/foundry.canvas.rendering.shaders.AdaptiveColorationShader.html).
...
- [AdaptiveColorationShader Class](https://foundryvtt.com/api/classes/foundry.canvas.rendering.shaders.AdaptiveColorationShader.html)
- [ShaderTechnique Interface](https://foundryvtt.com/api/interfaces/foundry.ShaderTechnique.html)
- [AbstractBaseShader Class](https://foundryvtt.com/api/classes/foundry.canvas.rendering.shaders.AbstractBaseShader.html)