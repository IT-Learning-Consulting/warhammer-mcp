# BaseNote | Foundry Virtual Tabletop - API Documentation - Version 13

The Note Document. Defines the DataSchema and common behaviors for a Note which are shared between both client and server.

Mixes: NoteData

Hierarchy ([View Summary](https://foundryvtt.com/api/hierarchy.html#foundry.documents.BaseNote), Expand)
...
Returns an object containing `fields` and `joint` validation failures.  
...
- **data**:  
  Optional. Initial data used to create this Document, or a Document instance to persist. May be a single object, a Document, or an array of such.
...
_See also [Foundry Virtual Tabletop - API Documentation - Version 13](https://foundryvtt.com/api/index.html)_