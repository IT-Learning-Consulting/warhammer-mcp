# DenseSmokeDarknessShader | Foundry Virtual Tabletop - API Documentation - Version 13

Creates a dense smoke area

## Hierarchy  
[View Summary](https://foundryvtt.com/api/hierarchy.html#foundry.canvas.rendering.shaders.DenseSmokeDarknessShader) (Expand)  
...
Check vision modes requirements first, then if key uniforms are at their default values, we don't need to render the background container.
...
For more details, visit the [Foundry Virtual Tabletop API Documentation - Version 13](https://foundryvtt.com/api/classes/foundry.canvas.rendering.shaders.DenseSmokeDarknessShader.html).