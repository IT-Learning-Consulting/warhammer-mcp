...
[Foundry Virtual Tabletop - API Documentation - Version 13](https://foundryvtt.com/api/modules.html) / [foundry](https://foundryvtt.com/api/modules/foundry.html) / [canvas /](https://foundryvtt.com/api/modules/foundry.canvas.html) [rendering /](https://foundryvtt.com/api/modules/foundry.canvas.rendering.html) [shaders](https://foundryvtt.com/api/modules/foundry.canvas.rendering.shaders.html) / [IlluminationVisionShader](https://foundryvtt.com/api/classes/foundry.canvas.rendering.shaders.IlluminationVisionShader.html)
...
- **Returns:**  
  The constructed shader adaptive block (`string`).  
