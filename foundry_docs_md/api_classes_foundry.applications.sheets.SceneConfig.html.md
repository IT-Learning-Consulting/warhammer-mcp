# SceneConfig | Foundry Virtual Tabletop - API Documentation - Version 13
...
- [DocumentSheetV2](https://foundryvtt.com/api/classes/foundry.applications.api.DocumentSheetV2.html)<this>
- **SceneConfig**
...
_Inherited from_ `HandlebarsApplicationMixin(DocumentSheetV2).options`
...
_Inherited from_ `HandlebarsApplicationMixin(DocumentSheetV2).position`
...
_Inherited from_ `HandlebarsApplicationMixin(DocumentSheetV2).tabGroups`
...
application. Any DEFAULT_OPTIONS of super-classes further upstream of the BASE_APPLICATION are ignored. Hook events for super-classes further upstream of the  
...
```typescript
PARTS: {
    ambience: { scrollable: string[]; template: string };
    basics: { template: string };
    footer: { template: string };
    grid: { template: string };
    lighting: { scrollable: string[]; template: string };
...
_Inherited from_ `HandlebarsApplicationMixin(DocumentSheetV2).classList`
...
_Inherited from_ `HandlebarsApplicationMixin(DocumentSheetV2).document`
...
_Inherited from_ `HandlebarsApplicationMixin(DocumentSheetV2).element`
...
_Inherited from_ `HandlebarsApplicationMixin(DocumentSheetV2).form`
...
_Inherited from_ `HandlebarsApplicationMixin(DocumentSheetV2).hasFrame`
...
_Inherited from_ `HandlebarsApplicationMixin(DocumentSheetV2).id`
...
_Inherited from_ `HandlebarsApplicationMixin(DocumentSheetV2).isEditable`
...
_Inherited from_ `HandlebarsApplicationMixin(DocumentSheetV2).isVisible`
...
_Inherited from_ `HandlebarsApplicationMixin(DocumentSheetV2).minimized`
...
_Inherited from_ `HandlebarsApplicationMixin(DocumentSheetV2).rendered`
...
_Inherited from_ `HandlebarsApplicationMixin(DocumentSheetV2).state`
...
_Inherited from_ `HandlebarsApplicationMixin(DocumentSheetV2).title`
...
_Inherited from_ `HandlebarsApplicationMixin(DocumentSheetV2).window`
...
_Inherited from_ `HandlebarsApplicationMixin(DocumentSheetV2)._canRender`
...
_Inherited from_ `HandlebarsApplicationMixin(DocumentSheetV2)._configureRenderOptions`
...
_Inherited from_ `HandlebarsApplicationMixin(DocumentSheetV2)._headerControlButtons`
...
_Inherited from_ `HandlebarsApplicationMixin(DocumentSheetV2)._initializeApplicationOptions`
...
_Overrides_ `HandlebarsApplicationMixin(DocumentSheetV2)._onChangeForm`
...
_Overrides_ `HandlebarsApplicationMixin(DocumentSheetV2)._onClose`
...
_Inherited from_ `HandlebarsApplicationMixin(DocumentSheetV2)._onFirstRender`
...
_Overrides_ `HandlebarsApplicationMixin(DocumentSheetV2)._onRender`
...
**Returns**: `Promise` of context including application document and user information.

_Overrides_ `HandlebarsApplicationMixin(DocumentSheetV2)._prepareContext`
...
_Inherited from_ `HandlebarsApplicationMixin(DocumentSheetV2)._preparePartContext`
...
_Overrides_ `HandlebarsApplicationMixin(DocumentSheetV2)._processSubmitData`
...
_Inherited from_ `HandlebarsApplicationMixin(DocumentSheetV2)._renderFrame`
...
- **options**: [ApplicationRenderOptions](https://foundryvtt.com/api/interfaces/foundry.applications.types.ApplicationRenderOptions.html) & [DocumentSheetRenderOptions](https://foundryvtt.com/api/interfaces/foundry.DocumentSheetRenderOptions.html) — Options which configure application rendering behavior
...
_Inherited from_ `HandlebarsApplicationMixin(DocumentSheetV2)._renderHTML`
...
_Inherited from_ `HandlebarsApplicationMixin(DocumentSheetV2).addEventListener`
...
_Inherited from_ `HandlebarsApplicationMixin(DocumentSheetV2).bringToFront`
...
_Overrides_ `HandlebarsApplicationMixin(DocumentSheetV2).changeTab`
...
```typescript
close(options?: Partial<ApplicationClosingOptions>): Promise<SceneConfig>
```
...
_Inherited from_ `HandlebarsApplicationMixin(DocumentSheetV2).close`
...
_Inherited from_ `HandlebarsApplicationMixin(DocumentSheetV2).dispatchEvent`
...
_Inherited from_ `HandlebarsApplicationMixin(DocumentSheetV2).maximize`
...
_Inherited from_ `HandlebarsApplicationMixin(DocumentSheetV2).minimize`
...
_Inherited from_ `HandlebarsApplicationMixin(DocumentSheetV2).removeEventListener`
...
_Inherited from_ `HandlebarsApplicationMixin(DocumentSheetV2).render`
...
_Inherited from_ `HandlebarsApplicationMixin(DocumentSheetV2).setPosition`
...
_Inherited from_ `HandlebarsApplicationMixin(DocumentSheetV2).submit`
...
_Inherited from_ `HandlebarsApplicationMixin(DocumentSheetV2).toggleControls`
...
_Inherited from_ `HandlebarsApplicationMixin(DocumentSheetV2)._attachFrameListeners`
...
_Inherited from_ `HandlebarsApplicationMixin(DocumentSheetV2)._createContextMenu`
...
_Inherited from_ `HandlebarsApplicationMixin(DocumentSheetV2)._getHeaderControls`
...
_Inherited from_ `HandlebarsApplicationMixin(DocumentSheetV2)._getTabsConfig`
...
_Inherited from_ `HandlebarsApplicationMixin(DocumentSheetV2)._insertElement`
...
_Inherited from_ `HandlebarsApplicationMixin(DocumentSheetV2)._onClickAction`
...
_Inherited from_ `HandlebarsApplicationMixin(DocumentSheetV2)._onClickTab`
...
_Inherited from_ `HandlebarsApplicationMixin(DocumentSheetV2)._onPosition`
...
_Inherited from_ `HandlebarsApplicationMixin(DocumentSheetV2)._onRevealSecret`
...
_Inherited from_ `HandlebarsApplicationMixin(DocumentSheetV2)._onSubmitForm`
...
_Inherited from_ `HandlebarsApplicationMixin(DocumentSheetV2)._preClose`
...
_Inherited from_ `HandlebarsApplicationMixin(DocumentSheetV2)._preFirstRender`
...
- **formData**: [FormDataExtended](https://foundryvtt.com/api/classes/foundry.applications.ux.FormDataExtended.html) — Processed data for the submitted form
...
_Inherited from_ `HandlebarsApplicationMixin(DocumentSheetV2)._prepareSubmitData`
...
_Inherited from_ `HandlebarsApplicationMixin(DocumentSheetV2)._prepareTabs`
...
_Inherited from_ `HandlebarsApplicationMixin(DocumentSheetV2)._prePosition`
...
_Inherited from_ `HandlebarsApplicationMixin(DocumentSheetV2)._preRender`
...
_Inherited from_ `HandlebarsApplicationMixin(DocumentSheetV2)._processFormData`
...
_Inherited from_ `HandlebarsApplicationMixin(DocumentSheetV2)._removeElement`
...
_Inherited from_ `HandlebarsApplicationMixin(DocumentSheetV2)._renderHeaderControl`
...
_Inherited from_ `HandlebarsApplicationMixin(DocumentSheetV2)._replaceHTML`
...
_Inherited from_ `HandlebarsApplicationMixin(DocumentSheetV2)._tearDown`
...
_Inherited from_ `HandlebarsApplicationMixin(DocumentSheetV2)._toggleDisabled`
...
_Inherited from_ `HandlebarsApplicationMixin(DocumentSheetV2)._updateFrame`
...
_Inherited from_ `HandlebarsApplicationMixin(DocumentSheetV2)._updatePosition`
