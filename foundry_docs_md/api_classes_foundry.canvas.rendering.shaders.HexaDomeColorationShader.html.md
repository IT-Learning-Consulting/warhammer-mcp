...
### SHADER_TECHNIQUES  
**Type:** `Record<string, foundry.ShaderTechnique>`  
...
For more information, visit the [Foundry Virtual Tabletop - API Documentation - Version 13](https://foundryvtt.com/api/classes/foundry.canvas.rendering.shaders.HexaDomeColorationShader.html) page.