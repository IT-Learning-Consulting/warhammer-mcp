...
The singleton collection of JournalEntry documents which exist within the active World. This Collection is accessible within the Game object as `game.journal`.

**See**

- [foundry.documents.JournalEntry](https://foundryvtt.com/api/classes/foundry.documents.JournalEntry.html): The JournalEntry document  
- [foundry.applications.sidebar.tabs.JournalDirectory](https://foundryvtt.com/api/classes/foundry.applications.sidebar.tabs.JournalDirectory.html): The JournalDirectory sidebar directory

**Hierarchy** ([View Summary](https://foundryvtt.com/api/hierarchy.html#foundry.documents.collections.Journal), Expand)  
`WorldCollection`  
**Journal**
...
`static documentName: string = "JournalEntry"`  
...
```typescript
static show(
  doc: documents.JournalEntry | documents.JournalEntryPage,
  options?: { force?: boolean; users?: string[] },
): void | Promise<documents.JournalEntry | documents.JournalEntryPage>
```

Show the JournalEntry or JournalEntryPage to connected players. By default, the document will only be shown to players who have permission to observe it. If the force parameter is passed, the document will be shown to all players regardless of normal permission.

**Parameters**

- **doc**: `documents.JournalEntry | documents.JournalEntryPage`  
  The JournalEntry or JournalEntryPage to show.
- **options**: `{ force?: boolean; users?: string[] } = {}` (optional)  
...
A Promise that resolves back to the shown document once the request is processed.
...
- **config**: `ShareImageConfig = {}` (optional)  
