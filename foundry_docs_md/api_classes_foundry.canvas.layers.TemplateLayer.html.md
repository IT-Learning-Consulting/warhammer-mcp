# TemplateLayer | Foundry Virtual Tabletop - API Documentation - Version 13

This Canvas Layer provides a container for MeasuredTemplate objects.

## Hierarchy  
[View Summary](https://foundryvtt.com/api/hierarchy.html#foundry.canvas.layers.TemplateLayer)  
...
### hookName  
`get hookName(): string`  
The name used by hooks to construct their hook string. Note: Override if different from constructor name.  
...
Inherited from [PlaceablesLayer._onDragLeftCancel](https://foundryvtt.com/api/classes/foundry.canvas.layers.PlaceablesLayer.html#_onDragLeftCancel).
...
**Returns**  
- The new PlaceableObject instance  
...
**Returns**  
- Promise resolving to CanvasLayer  
...
**Returns**  
- An array or DocumentCollection of documents  
...
- **options?**:  
  ...
  - **ids?**: string[] — An array of object IDs to target for movement. Defaults to controlled objects IDs.  
...
**Parameters**  
- **options?**:  
  - **controlOptions?**: object — Optional arguments for any called control() method.  
  - **height?**: number — The height of the selection rectangle.  
  - **releaseOptions?**: object — Optional arguments for any called release() method.  
...
**Returns**  
- A boolean indicating whether the controlled set was changed in the operation.  
...
Subclasses may override and call the base [PlaceablesLayer._storeHistory](https://foundryvtt.com/api/classes/foundry.canvas.layers.PlaceablesLayer.html#_storeHistory) themselves to pass options.  
**Parameters**  
...
```
Undo a change to the objects in this layer. Typically activated using CTRL+Z while the layer is active.  
**Returns**  
- An array of documents modified by the undo operation  
...
**Returns**  
- The transformed x, y coordinates, or false if the drag event was outside the canvas.  
...
- [PlaceablesLayer Documentation](https://foundryvtt.com/api/classes/foundry.canvas.layers.PlaceablesLayer.html)