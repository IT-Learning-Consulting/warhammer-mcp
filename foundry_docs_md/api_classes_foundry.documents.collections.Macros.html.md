# Macros | Foundry Virtual Tabletop - API Documentation - Version 13
...
- [foundry.documents.Macro: The Macro document](https://foundryvtt.com/api/classes/foundry.documents.Macro.html)  
- [foundry.applications.sidebar.tabs.MacroDirectory: The MacroDirectory sidebar directory](https://foundryvtt.com/api/classes/foundry.applications.sidebar.tabs.MacroDirectory.html)

**Hierarchy** ([View Summary](https://foundryvtt.com/api/hierarchy.html#foundry.documents.collections.Macros))  
...
Register a Document sheet class as a candidate which can be used to display Documents of a given type. See [DocumentSheetConfig.registerSheet](https://foundryvtt.com/api/classes/foundry.applications.apps.DocumentSheetConfig.html#registerSheet) for details.
