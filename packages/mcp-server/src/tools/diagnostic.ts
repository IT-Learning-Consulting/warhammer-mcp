...
- **scan-career-refs**: Walk actor careers for skill/talent name references that don't resolve via exact-name lookup in world items. Read-only fallback — does NOT call WFRP_Utility.findSkill (which may rename-mutate the source). Returns {checked, unresolved, elapsedMs, details?}.
